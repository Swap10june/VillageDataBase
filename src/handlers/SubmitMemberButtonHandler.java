	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getActionCommand().equalsIgnoreCase("Add Family Head"))
		{
			...
			else
			{
				...
				member.setM_tal(addMember.getTxtTalStatus().getText().trim());
				member.setM_gaon(addMember.getTxtVillageStatus().getText().trim());
				...
				AddFamily.getListOfHead().add(member.getMember_id()+UConstants.STRING_SPLIT+member.getM_name_e());
		...
		if(e.getActionCommand().equalsIgnoreCase("Add Member"))
		{
			...
			else 
			{
				...
				member.setM_contact(addMember.getTxtContStatus().getText());
				addMember.setMember(member);
				AddFamily.listOfMembers.add(member.getMember_id()+UConstants.STRING_SPLIT+member.getM_name_e());
				owner.dispose();
			}
		}
